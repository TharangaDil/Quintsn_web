...
export const ShineButton: React.FC<ShineButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`relative group text-white font-medium rounded-md min-w-[120px] min-h-[44px]
        transition-all duration-700 ease-in-out cursor-pointer border-none
    ...
    >
      ...
      <div
        ...
        bg-white/40 skew-x-[-20deg] opacity-0 
