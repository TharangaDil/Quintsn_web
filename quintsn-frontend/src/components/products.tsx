            ...
            <div className="py-8 overflow-hidden">
              ...
              >
                {duplicated.map((tech, idx) => (
                  ...
                  >
                    <div className="relative w-[100px] h-[100px] rounded-2xl bg-card border border-border flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-300 overflow-hidden">
                      {/* Glow */}
                      <motion.div
