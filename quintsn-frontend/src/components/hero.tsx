    ...
    <section id="hero" className="relative w-full h-screen overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            Struggling to manage multiple systems and manual workflows? You're not alone. But you don't have to settle for inefficiency. Quintessential can help you navigate the complex landscape of business technology solutions - and find the perfect fit for your business.
          </motion.p>
